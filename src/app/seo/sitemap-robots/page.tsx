...
export default function SitemapRobotsPage() {
  ...
  // Fetch data from global SEO config
  useEffect(() => {
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto mt-2 md:mt-0">
              ...
              >
                ...
                <ExternalLink className="w-3.5 h-3.5 text-gray-400 group-hover:text-[#2D6FBA] transition-colors" />
              </a>
        ...
        <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
              <Globe className="w-5 h-5 text-[#2D6FBA]" />
              Sitemap Options
            </h3>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 border border-gray-100 rounded-2xl mt-2">
              <div className="flex flex-col gap-1 pr-4">
                ...
                <span className="text-[10px] text-gray-400 font-light">
                  Automatically compiles static links and published pages into a
                  sitemap format.
                </span>
              </div>
              <label className="relative inline-flex items-center cursor-pointer select-none">
                ...
                />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#2D6FBA]"></div>
              </label>
            </div>
            ...
            <div className="flex flex-col gap-3 p-4 border border-dashed border-gray-200 rounded-2xl">
              ...
              {formData.sitemapCustomContent && (
                <div className="flex items-center gap-2 p-2.5 bg-amber-50/50 border border-amber-100 rounded-xl text-[10px] text-amber-700 font-medium animate-in slide-in-from-top-1 duration-200">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                rows={8}
                className="w-full font-mono text-xs p-4 bg-gray-50 text-gray-800 border border-gray-200 focus:border-[#2D6FBA] focus:bg-white transition-all rounded-2xl outline-none"
              />
            </div>
          </div>
        </div>
