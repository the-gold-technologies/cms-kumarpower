...
export default function PageSEODashboard() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full pb-20 animate-in fade-in duration-500">
      ...
      <div className="bg-white p-4 rounded-3xl border border-gray-50 shadow-sm flex items-center gap-4 px-6 focus-within:ring-1 focus-within:ring-[#2D6FBA] transition-all">
        <Search className="w-5 h-5 text-gray-400" />
        <input
          type="text"
          placeholder="Search pages by title or slug..."
          className="flex-1 bg-transparent border-none outline-none text-sm font-medium text-slate-700 placeholder:text-gray-400"
          value={searchQuery}
      ...
      <div className="overflow-hidden rounded-[2rem] bg-white shadow-sm ring-1 ring-gray-100/50">
              ...
              {isLoading ? (
                <tr>
                  <td colSpan={6} className="py-20 text-center">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#2D6FBA] mx-auto"></div>
                  </td>
                </tr>
              ) : rootLinks.length === 0 ? (
                <tr>
                          ...
                          <div className="flex items-center gap-3">
                            {root.type !== "Dropdown" && (
                              <Link
                                ...
                                className="p-2 bg-gray-50 text-slate-700 rounded-xl hover:bg-[#2D6FBA] hover:text-white transition-all group"
                                title="Edit SEO"
                              >
                            ...
                            >
                              ...
                              <td className="px-6 py-4">
                                <div className="flex items-center gap-3 pl-6 border-l-2 border-gray-100/50">
                                  ...
                                  <div className="flex flex-col">
                                    <span className="font-medium text-xs text-gray-600 group-hover:text-slate-800 transition-colors">
                                      {child.title}
                                    </span>
                                  </div>
                                </div>
                              ...
                              <td className="px-6 py-4">
                                <div className="flex items-center gap-3">
                                  <Link
                                    ...
                                    className="p-1.5 bg-white border border-gray-100 text-gray-400 rounded-lg hover:border-[#2D6FBA] hover:text-[#2D6FBA] transition-all"
                                  >
