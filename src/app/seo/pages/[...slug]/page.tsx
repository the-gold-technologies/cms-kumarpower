  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (json.success) {
        ...
        toast.error(json.error || "Update failed.", { id: tid });
      }
    } catch (error) {
  ...
  return (
    <div className="flex flex-col gap-8 w-full pb-20 animate-in fade-in duration-500">
      <div className="flex flex-col gap-4">
        <Link
          href="/seo/pages"
          className="flex items-center gap-2 text-sm font-bold text-gray-400 hover:text-[#2D6FBA] transition-colors w-fit group"
        >
      ...
      <div className="w-full">
        <div className="w-full flex flex-col gap-6 bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden">
          ...
          <InputField
            ...
            placeholder="e.g. Services | Kumar Power"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <InputField
              ...
              placeholder="e.g. generator dealer, kirloskar green, amc services"
            ...
            <InputField
              ...
              placeholder="https://www.kumarpower.com/page"
