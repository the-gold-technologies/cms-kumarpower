          ...
          <div className="overflow-hidden flex flex-col gap-4 pt-1">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <InputField
                ...
                placeholder="Solar Panels & Systems"
              />
            </div>
            <TextAreaField
        ...
        >
          <div className="overflow-hidden flex flex-col gap-4 pt-1">
            <InputField
              ...
              placeholder="Solar Photovoltaic Panel Range"
            />
            <TextAreaField
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <InputField
                      ...
                      placeholder="e.g. 550W Tier-1 Mono PERC Solar Panel"
                    />
                    <InputField
                      label="Power Rating (e.g. 550 Watt)"
                      value={p.powerRating}
                      onChange={(e) =>
                        handleProductChange(p.id, "powerRating", e.target.value)
                      }
                      placeholder="550 Watt"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <InputField
                      ...
                      value={p.efficiency}
                      onChange={(e) =>
                        handleProductChange(p.id, "efficiency", e.target.value)
                      }
                      placeholder="21.3%"
                    />
                    <InputField
                      ...
                      value={p.cellType}
                      onChange={(e) =>
                        handleProductChange(p.id, "cellType", e.target.value)
                      }
                      placeholder="Mono PERC 182mm"
                    />
                    <InputField
                      label="Technology"
                      value={p.technology}
                      onChange={(e) =>
                        handleProductChange(p.id, "technology", e.target.value)
                      }
                      placeholder="144 Half-Cut Cells"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <InputField
                      ...
                      value={p.warranty}
                      onChange={(e) =>
                        handleProductChange(p.id, "warranty", e.target.value)
                      }
                      placeholder="25 Yrs Performance"
                    />
                    <InputField
                      ...
                      placeholder="Commercial Complexes, Sheds, Warehouses"
                    />
                  </div>
