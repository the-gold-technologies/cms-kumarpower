...
export default function DistributionTransformersCMSPage() {
  ...
  // Why Choose Section
  const [whyChooseTitle, setWhyChooseTitle] = useState("Why Choose Kumar Power Transformers?");
  ...
  const [whyChooseCard2Title, setWhyChooseCard2Title] = useState("Energy Efficiency");
