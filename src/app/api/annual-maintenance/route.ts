...
const PAGE_SLUG = "annual-maintenance";
...
export async function GET() {
  try {
    ...
    console.error("Error fetching annual-maintenance content:", error);
...
export async function PUT(request: Request) {
  try {
    ...
    console.error("Error saving annual-maintenance section:", error);
    return NextResponse.json(
      { success: false, error: "Internal Server Error" },
      { status: 500 }
    );
