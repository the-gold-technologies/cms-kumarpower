...
const PAGE_SLUG = "kirloskar-diesel-generator";
...
export async function GET() {
  try {
    ...
    console.error("Error fetching kirloskar-diesel-generator content:", error);
...
export async function PUT(request: Request) {
  try {
    ...
    console.error("Error saving kirloskar-diesel-generator section:", error);
    return NextResponse.json(
      { success: false, error: "Internal Server Error" },
      { status: 500 }
    );
