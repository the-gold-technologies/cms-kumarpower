...
const PAGE_SLUG = "kirloskar-gas-generator";
...
export async function GET() {
  try {
    ...
    console.error("Error fetching kirloskar-gas-generator content:", error);
...
export async function PUT(request: Request) {
  try {
    ...
    console.error("Error saving kirloskar-gas-generator section:", error);
    return NextResponse.json(
      { success: false, error: "Internal Server Error" },
      { status: 500 }
    );
