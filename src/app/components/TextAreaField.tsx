          ...
          <form onSubmit={handleInsertLink} className="flex flex-col gap-3">
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-xs focus:ring-1 focus:ring-[#2D6FBA] focus:border-[#2D6FBA] outline-none text-gray-800"
              />
            </div>
            ...
            <div className="flex gap-2 justify-end pt-2">
              ...
              <button
                type="submit"
                className="px-4 py-1.5 bg-[#2D6FBA] text-white rounded-lg text-xs font-semibold hover:bg-[#1a5a9e] cursor-pointer transition-colors"
              >
                Insert
              </button>
            </div>
